...
$sql = "select * from `register` where idregister='$idstudent' and s_check ='1' LIMIT 1";
...
<body>
    ...
    <div class="page">
        <div class="subpage">
            ...
            <div style="padding-top: 45px; float: right; padding-right: 40px;"><img width="136" src="./upload/<?php echo $fet['u_id']; ?>/<?php echo $fet['evi_3']; ?>" alt=""></div>
