          ...
          <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                ...
                <form action="./process/edit_register66.php" method="post" enctype="multipart/form-data" class="form-horizontal" name="register-form">
                    ...
                    <div class="col-xl-12">
                      ...
                      <div class="col-xl-6">
                        <div class="form-group">
                          ...
                          <label class="col-md-12 col-sm-12 col-form-label">ผลการเรียนเฉลี่ยสะสมรายวิชาพื้นฐานทุกรายวิชาของกลุ่มสาระการเรียนรู้ภาษาต่างประเทศ (ภาษาอังกฤษ) (5 ภาคเรียน) <span style="color: red; font-weight: bold;">*</span></label>
                          <div class="col-md-3 col-sm-3">
                      ...
                      <br />
                      <button name="edit_register" type="submit" class="btn btn-primary btn-sm">แก้ไขข้อมูล</button>
                    </div>
                </form>
