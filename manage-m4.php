...
$sqlid_re = "select * from `register` where s_check = '0' order by id desc";
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h4 mb-2 text-gray-800">ตรวจสอบข้อมูลการสมัครคัดเลือกเข้าเรียนโครงการห้องเรียน พสวท. (สู่ความเป็นเลิศ) ปีการศึกษา 2567 (รอบที่ 2)</h1>
            <!-- DataTales Example -->
                  ...
                  <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          <td><?php echo $i; ?></td>
                          <td><?php echo $fetid_re['title'] . $fetid_re['name'] . "&nbsp;&nbsp;&nbsp;" . $fetid_re['surname']; ?> <?php if ($fetid_re['comment'] != "0") { ?><span class="btn btn-warning btn-sm">รอการดำเนินการ</span><?php } ?></td>
                          <td><?php echo $fetid_re['school']; ?></td>
                          <td><?php echo $fetid_re['telephone']; ?></td>
                          <td><?php echo $fetid_re['telephone2']; ?></td>
                          <td>
                            <span class="text-primary"><?php echo convert_date_func($fetid_re['datet'], "digit"); ?></span>
                          </td>
