                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">
                                            ป้อนรหัสผ่านใหม่ และ ทำการยืนยันรหัสผ่าน
                                    ...
                                    if ($fet_se['se_value'] == '1') {
                                        ...
                                        <form action="process/new_password.php" method="post">
                                            <div class="form-group">
                                                <input name="password1" type="password" class="form-control form-control-user mb-3" id="InputUser" placeholder="รหัสผ่าน" required />
                                                <input name="password2" type="password" class="form-control form-control-user" id="InputUser" placeholder="ยืนยันรหัสผ่าน" required />
                                            </div>

                                            <button name="newpassword" class="btn btn-primary btn-user btn-block" type="submit" value="Submit">
                                                รีเซ็ตรหัสผ่าน
                                            </button>
                                        </form>
                                    <?php
