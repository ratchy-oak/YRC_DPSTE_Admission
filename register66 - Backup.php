      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-2 text-gray-800">สมัครคัดเลือกเข้าเรียนชั้นมัธยมศึกษาปีที่ 4 โครงการห้องเรียน พสวท.(สู่ความเป็นเลิศ)</h1>
            <!-- DataTales Example -->
                    ...
                    <tbody>
                      <tr>
                        <td width="20%">
                          ...
                          <p style="padding-top:6px; margin:0;">โครงการห้องเรียน พสวท. (สู่ความเป็นเลิศ) ศูนย์โรงเรียนยุพราชวิทยาลัย
                            <br />
                            <br />
                            <span style="color: green;"><u style="font-weight: bold;">ผลการเรียนเฉลี่ยสะสม 5 ภาคเรียน (ชั้น ม.1 ม.2 และ ม.3 ภาคเรียนที่ 1)</u></span>
                            <br>
                        ...
                        <td>
                          <span style="color: green;"><u style="font-weight: bold;">หลักฐานการสมัคร</u><br>
                            ...
                            <table class="table table-bordered" width="100%" cellspacing="0">
                              <tr>
                                <form action="./process/add_evidence.php" method="post" enctype="multipart/form-data" name="evidance-form">
                                  <td>
                                    ใบสมัคร:<br>
                                  </td>
                                  <td>
                                    ...
                                    if ($fetid_re['evi_1'] != "0") {
                                    ?>
                                      <input class="" type="file" id="fileupload" name="fileupload" required />
                                      <button name="add_evidance1" type="submit" class="mt-2 btn btn-primary btn-sm">บันทึก</button>
                                    <?php
                                    ...
                                    ?>
                                      ...
                                      if ($fetid_re['s_check'] != "1") { ?>
                                        <a href="./process/delete_evidence1.php?delete_evidence1" class="mb-2 btn btn-danger btn-sm" onclick="return confirm('ต้องการลบไฟล์ข้อมูลนี้ ใช่หรือไม่?')">ลบ</a><br />
                                      <?php } ?>
                              ...
                              <tr>
                                <form action="./process/add_evidence.php" method="post" enctype="multipart/form-data" name="evidance-form">
                                  ...
                                  <td>
                                    ...
                                    ?>
                                      <input class="" type="file" id="fileupload" name="fileupload" required />
                                      <button name="add_evidance2" type="submit" class="mt-2 btn btn-primary btn-sm">บันทึก</button>
                                    <?php
                                      //}
                                    }
                                    ?>
                                  ...
                                  <td>
                                    <?php
                                    if ($fetid_re['s_check'] != "1") { ?>
                                      <a href="./process/delete_evidence1.php?delete_evidence2" class="mb-2 btn btn-danger btn-sm" onclick="return confirm('ต้องการลบไฟล์ข้อมูลนี้ ใช่หรือไม่?')">ลบ</a>
                                    <?php } ?>
                              ...
                              <tr>
                                <form action="./process/add_evidence.php" method="post" enctype="multipart/form-data" name="evidance-form">
                                  <td>
                                    เอกสารแสดงผลการเรียน 5 ภาคเรียน (ใสได้หลายไฟล์)<br>
                                  </td>
                                  <td>
                                    <?php
                                    if ($fetid_re['s_check'] == "0") {
                                      //if ($fetid_re['evi_1'] == "") { 
                                    ?>
                                      <input type="file" id="fileupload" name="fileupload[]" multiple="multiple" required />
                                      <button name="add_evidance2" type="submit" class="mt-2 btn btn-primary btn-sm">บันทึก</button>
                                    <?php
                                      //}
                                    }
                                  ...
                                  <td>
                                    <ul style="margin:0; padding: 0; list-style-type: none;">
                                      <?php
                                      if ($fetid_re['evi_3'] != "0") {
                                        //$e5_check = explode("#", $fetide['e5']);
                                        $f6 = explode("#", $fetid_re['evi_3']);
                                      ...
                                      ?>
                                            <li>
                                              <?php
                                              if ($fetid_re['s_check'] != "1") { ?>
                                                <a href="./process/delete_evidence1.php?delete_evidence2" class="mb-2 btn btn-danger btn-sm" onclick="return confirm('ต้องการลบไฟล์ข้อมูลนี้ ใช่หรือไม่?')">ลบ</a><br />
                                              <?php } ?>
                                              <a href="upload/<?php echo $_SESSION['id']; ?>/<?php echo $fetid_re['evi_3']; ?>" target="_blank"><img class="img-fluid" src="upload/<?php echo $_SESSION['id']; ?>/<?php echo $row; ?>" alt=""></a>
                                            </li>
                                      <?php
                                          }
                                        }
                              ...
                              <tr>
                                <form action="./process/add_evidence.php" method="post" enctype="multipart/form-data" name="evidance-form">
                                  ...
                                  <td>
                                    <?php
                                    if ($fetid_re['s_check'] != "1") { ?>
                                      <a href="./process/delete_evidence4.php?delete_evidence4" class="mb-2 btn btn-danger btn-sm" onclick="return confirm('ต้องการลบไฟล์ข้อมูลนี้ ใช่หรือไม่?')">ลบ</a><br />
                                    <?php } ?>
                                    <a href="upload/<?php echo $_SESSION['id']; ?>/<?php echo $fetid_re['evi_4']; ?>" target="_blank"><img class="img-fluid" src="upload/<?php echo $_SESSION['id']; ?>/<?php echo $fetid_re['evi_4']; ?>" alt=""></a>
                                  </td>
                                  <td>
                                    <?php
                                    if ($fetid_re['evi_4'] != "") {
